...
{
    public partial class ctrlLocalDrivingLicenseInfoFilter : UserControl
    {
        ...
        public ctrlLocalDrivingLicenseInfoFilter()
        {
            InitializeComponent();
        }
        ...
        public void LoadLicenseInfo(int LicenseID)
        {
            ...
            ctrlDrivingLicenseInfo1.LoadLicenceInfo(LicenseID);
